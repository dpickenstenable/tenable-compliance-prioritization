---
name: "Compliance Prioritizer Agent"
...
The Compliance Prioritizer Agent transforms overwhelming compliance scan results into actionable, risk-ranked remediation plans. When security teams face hundreds or thousands of failed compliance checks, this agent applies intelligent risk scoring to focus effort where it matters most.

## What it does

The agent analyzes Tenable Vulnerability Management compliance scans and generates four comprehensive reports:
